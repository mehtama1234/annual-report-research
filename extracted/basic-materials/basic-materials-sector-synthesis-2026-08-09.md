...
The four-company set breaks the sector into distinct but connected physical systems:
...
`Basic Materials` in the `2025` annuals and late-`2025` / `2026` quarterlies reads less like a generic commodity sector and more like a set of strategic physical systems under pressure to be reliable, scalable, and politically secure.

The strongest names in the local archive are not only selling materials. They are operating critical inputs into energy, electrification, manufacturing, infrastructure, and food production.

## Next best extensions

- Add a chemicals-heavy name if the goal is to test whether the current packet overweights extractive and upstream systems relative to processing and specialty inputs.
