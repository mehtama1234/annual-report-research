...
The completed consumer-goods set supports a clear sector conclusion: `Consumer Goods` in the 2025 annuals and late-2025 / 2026 quarterlies is not one simple brand-pricing story. It is a sector splitting across at least three different demand and earnings models:
...
### 1. Consumer goods is fragmenting by category quality, not just by brand strength

The six-company set already breaks into distinct economic roles:
...
This means “consumer goods” is already too blunt as a single label. Habitual household and personal-care categories, food-and-beverage portfolios, and beauty exposure are behaving differently enough that the better question is which category system a company sits inside and whether that system is trust-led, routine-use, health-adjacent, or trend-sensitive.
...
### 5. International breadth is a major stabilizer
...
### 6. Health, trust, and routine are major demand anchors
...
### 7. Capital return is still a core part of the sector identity
...
`Consumer Goods` in the 2025 annuals and late-2025 / 2026 quarterlies is best understood as a sector where resilient earnings increasingly come from trusted routine-use categories, affordability architecture, international breadth, health-adjacent demand, and disciplined productivity execution rather than from simple across-the-board pricing power.
