# The Kraft Heinz Company Source Ledger
...
- The AnnualReports page, the official IR annual-report chain, and the SEC submissions index all reconcile to `The Kraft Heinz Company` / `Kraft Heinz Co`, ticker `KHC`, and the fiscal year ended `2025-12-27`.
- The local archive has a clean annual-report pair from both AnnualReports and official IR, plus a direct official Q4 `2025` through Q2 `2026` quarter-material chain.
- Direct SEC filing content was not retrievable from this shell environment on `2026-08-10` because SEC returned anti-automation denials, so the saved SEC evidence here is the submissions JSON plus the access note that maps the exact filing accessions.

## Most important evidence for the packet thesis

- The Q4 `2025` reset package shows the central break in the story: management paused separation work and announced `~$600 million` of reinvestment because the business had been underinvested and needed repair.
- Q1 `2026` shows early traction in Taste Elevation and international markets, but still with lower Adjusted EPS and lower Adjusted Operating Income.
- Q2 `2026` shows that investments are beginning to improve share and outlook, but also that the company is still intentionally spending harder to rebuild the U.S. business and defend affordability.
