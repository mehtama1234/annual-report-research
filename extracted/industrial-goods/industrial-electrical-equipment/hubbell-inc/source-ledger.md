...
| HUBB-T3 | 2025 annual report direct PDF URL, browser-verified | 2026-08-09 | Annual report PDF URL | Direct annual report source verified through the official hosted PDF even though the binary did not save locally in this pass | `[Disclosed]` | [ir-source-links.md](/home/manishmehta/ui-projects/annual-report-research/raw/company-ir/industrial-goods/industrial-electrical-equipment/hubbell-inc/ir-source-links.md) |
...
- The official annual report PDF URL was verified through the browser tool and the IR site, but the binary did not save locally during this pass because the hosted download path repeatedly hung in the shell environment.

## Missing evidence

- No official earnings-call transcript artifact was collected for Q4 2025, Q1 2026, or Q2 2026.
- No local binary copy of the official `2025` annual report PDF was saved in this pass despite the source URL being verified.
