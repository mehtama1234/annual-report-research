...
- The local packet does not yet include the official annual report PDF because the verified IR static-file URL stalled in shell download attempts during collection.
