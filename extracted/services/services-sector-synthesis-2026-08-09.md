...
- mall-sensitive branded apparel is also splitting internally: Gap shows that company-level recovery can coexist with a sharp internal brand-health gap, while American Eagle Outfitters shows a more binary version where Aerie is the stronger growth and relevance engine and the core American Eagle banner remains weaker
