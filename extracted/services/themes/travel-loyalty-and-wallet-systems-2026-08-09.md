...
All three names show a second economic layer beyond the basic service consumed.
...
- Add another airline, cruise, or gaming operator if the goal is to test whether the current loyalty-and-status conclusions are specific to the strongest brands.
