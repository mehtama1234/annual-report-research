...
- FY2025 total revenue: `$11.556B`
- FY2025 subscription solutions / merchant solutions: `$2.752B` / `$8.804B`
- FY2025 gross profit / income from operations / net income: `$5.555B` / `$1.468B` / `$1.231B`
- FY2025 MRR / GMV: `$205M` / `$378.4B`
- FY2025 Shopify Payments penetration: `65.6%`, representing `$248.1B` of GMV
- FY2025 management headline: `$11.6B` revenue, about `$2.0B` free cash flow, and a new `$2.0B` buyback authorization
- Q1 2026 revenue / GMV / MRR / gross profit / operating income / free cash flow: `$3.170B` / `$100.7B` / `$212M` / `$1.546B` / `$382M` / `$476M`
- Q1 2026 cash and cash equivalents / marketable securities: `$1.848B` / `$3.895B`
- Q1 2026 Shopify Payments penetration: `67%`, representing `$67.1B` of GMV
- Q2 2026 revenue / GMV / MRR / gross profit / operating income / free cash flow: `$3.583B` / `$115.6B` / `$221M` / `$1.708B` / `$488M` / `$654M`
- Q2 2026 cash and cash equivalents / marketable securities: `$1.656B` / `$3.291B`
- Q2 2026 Shopify Payments penetration: `68%`, representing `$78.1B` of GMV

## Limitations

- No earnings-call transcript was collected in this pass
- Direct shell pulls from SEC returned the automated-tool block page, so the SEC evidence is documented through verified URLs plus company-hosted filing mirrors rather than stored SEC HTML files
- The local file `2025-q4-press-release.pdf` is not a valid PDF and is excluded from evidence
