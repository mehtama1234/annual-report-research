# Fandom Participation Systems Index

Date baseline: 2026-08-10

## Scope

This index makes the play-and-participation blind-spot lane sortable across collectible fandom, brand-universe play, creator-world participation, and recurrent franchise wallet systems.
...
- separate physical-plus-digital fandom systems from digital-native participation systems
- separate collectible-ruleset fandom, brand-universe extension, and creator-world participation on one page
- separate creator-world participation from publisher-managed franchise monetization
- preserve play and fandom as a recurring cultural system rather than a generic toy or software bucket
- keep sports live-services participation distinct from broader franchise or creator-economy models

## Current best next moves

1. Reuse the direct comparison memo first when the question is whether a company belongs closer to collectible fandom, franchise-brand extension, or creator-world participation.
2. Extend the lane only if another company materially sharpens the split between collectible fandom, creator participation, and franchise-wallet behavior.
3. Compare this index against platform and consumer-cultural files when the goal is explaining where participation itself becomes the product.
4. Use the related memo when explaining why `Toys & Games` and `Application Software` are too blunt for modern play economies.
