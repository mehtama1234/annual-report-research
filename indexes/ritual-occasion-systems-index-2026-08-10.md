# Ritual Occasion Systems Index

Date baseline: 2026-08-10

## Scope

This index makes the ritual-demand blind-spot lane sortable across everyday routine, stimulation habit, premium occasion, and live-experience intensity.
...
- separate routine ritual systems from lower-frequency premium occasion systems
- separate stimulation-led beverage behavior from stored-value ordering habit
- keep live-experience intensity distinct from consumable ritual demand
- preserve this lane as a behavior system rather than a scatter across beverage, restaurant, and entertainment labels

## Current best next moves

1. Extend the lane only if another name materially sharpens the frequency-versus-occasion split.
2. Compare this index against loyalty, routine-use, and consumer-cultural files when the goal is separating necessity, ritual, and status demand.
3. Use the related memo when explaining why beverage, restaurant, and entertainment labels are too blunt for recurring culturally activated spending systems.
