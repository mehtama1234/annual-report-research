...
1. None. `Ferguson` moved from partial to completed once the clean neighboring packet and evidence chain were normalized into this worktree.
...
2. One technical-services or protection-services operator to deepen the asset-access and operating-support lane beyond `APi` and `Cintas`.
3. One narrower HVAC, waterworks, or industrial-supply distributor to sharpen comparison inside the wholesale infrastructure lane.
