...
- `Iridium Communications Inc.` if the archive next needs the satellite, narrowband, and subscription-heavy network-coverage comparison to the terrestrial tower and public-safety communications stack
