...
- `Cummins Inc.` if the archive next needs a larger engine-and-powertrain counterpoint on backup-power systems, distributed power, and mission-critical generation economics
