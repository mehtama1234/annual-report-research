...
- `Caci International Inc.` if the archive next needs the government-software, mission support, and defense-information-services comparison to the physical and communications infrastructure stack
- `Eaton Corporation plc` if the archive next needs the electrical-distribution, power-quality, switchgear, and datacenter-electrification counterpoint to Cummins, Vertiv, and Generac
