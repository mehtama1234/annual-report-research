...
- `Leidos Holdings, Inc.` if the archive next needs a larger-scale government-technology, mission-support, and program-management comparison against CACI’s more explicitly technology-first positioning
- `Booz Allen Hamilton Holding Corporation` if the archive next needs the analytics, cyber, AI-advisory, and federal digital-transformation comparison to CACI’s hardware-adjacent mission-systems stack
