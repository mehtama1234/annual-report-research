...
| Continuation-link audit | Checks that reusable continuation-mode notes that talk about already-open lanes or non-greenfield framing still expose the continuation-mode audit path. | [audit-continuation-mode-links.sh](../scripts/audit-continuation-mode-links.sh) | Present |
