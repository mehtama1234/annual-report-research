...
When you need to confirm that the offload storage model, manifest pointers, and note-layer references still line up before relying on this readme as the raw-storage source of truth, use:
