...
When you need to confirm that this workspace-integration review, the cross-repo bridge notes, and the broader continuation surfaces still line up before using it as a structural reference, use:
