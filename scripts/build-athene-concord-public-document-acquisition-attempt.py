...
ATTEMPTS = [
    ...
    },
    {
        ...
        "route_url": "https://www.kbra.com/publications/ZTyQYFzg; https://www.kbra.com/publications/xpNPQytP; https://www.kbra.com/sectors/abs/transactions?filterText=Concord+Music+Royalties,+LLC&sortField=Date",
        "route_status": "located-premium-access-controlled",
        "found_document_or_signal": "KBRA Series 2025-3 new-issue report page is visible but requires ABS Premium Subscription; accessible KBRA July 2026 surveillance page says the July payment-date review covered Series 2024-1 and 2025-1/2/3 and reports timely interest; the transaction page lists those surveillance entries.",
